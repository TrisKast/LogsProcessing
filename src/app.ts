...
const main = async (inputfilePath) => {
    ...
    console.table(computeAverageDurations(logFile, 'operationType', operationTypes));
    // Task 3b
    ...
    console.table(computeMaxDurations(logFile, 'operationType', operationTypes));
    // Task 4b
    ...
    console.table(computeMinDurations(logFile, 'operationType', operationTypes));
    // Task 5b
