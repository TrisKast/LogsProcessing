...
const fs = require('fs');
const { computeAverageDurations, computeMaxDurations, computeMinDurations } = require('./part1_functions');
// Part 2
/*
...
*/
exports.parseOPDurationsIntoDict = (inputFile, operationNames) => {
...
exports.parseOPDurationsToSQLString = (opDurationDict) => {
    // Build a string which will be used to generate the sql file
    let sqlInjectionString = `INSERT INTO GraphqlDurations
    ...
    for (const opName in opDurationDict) {
        const operation = opDurationDict[opName];
...
exports.writeSQLStringAsFile = (sqlString, outfile) => {
